...
Package.onUse(function(api) {
  ...
  'client/less/mixins.lessimport', 'client/less/animo.css', 'client/third_party/canvasresize.js', 'client/third_party/mousetrap.js',, 'client/third_party/diff.js', 'client/third_party/utils.js'], 'client');
  api.addFiles(['lib/collections.coffee', 'lib/config.json', 'client/aura.coffee'], ['client', 'server']);
  api.addFiles(['lib/credentials.coffee', 'server/server.coffee', 'server/seed.coffee'], 'server');
